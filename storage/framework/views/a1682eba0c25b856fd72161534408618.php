...
<head>
    ...
    <title>FishWiki</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <!-- <link rel="manifest" href="site.webmanifest"> -->
    <link rel="shortcut icon" type="image/x-icon" href="images/fishwiki.jpg">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-6 col-lg-7">
                            <div class="main-menu  d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        <li><a href="<?php echo e(url('commands')); ?>">Commands</a></li>
...
</html><?php /**PATH C:\xampp\htdocs\Treely_new\laravel\resources\views/navbar.blade.php ENDPATH**/ ?>